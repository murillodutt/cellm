...
- **Skills:**
  - `deprecate` - Skill for deprecation workflow with banners
  - `lifecycle` - Skill for complete doc lifecycle management
- **Templates:**
...
- Updated `writer` agent to include deprecate and lifecycle skills
...
- **Skills:**
  - `freshness` - Skill for evidence freshness validation
  - `redundancy` - Skill for redundancy detection with Jaccard similarity
- **Templates:**
...
- Updated `writer` agent to include freshness and redundancy skills
...
- **Skills:**
  - `prune` - Skill for documentation cleanup and archival
  - `gc` - Skill for garbage collection and maintenance
- **Configuration:**
...
- Updated `writer` agent to include new skills (prune, gc)
...
- **Skills:**
  - `init` - Skill for documentation initialization
  - `sync` - Skill for evidence synchronization
  - `verify` - Skill for documentation validation
- **Agent:**
  - `writer` - Documentation specialist for generating LLM-first docs
