...
[Learn more about Oracle →](./TECHNICAL-SPECS.md#oracle-architecture)
...
- 🗺️ **Pattern Tracking**: See which patterns are used and where
...
- [Technical Specs](./TECHNICAL-SPECS.md) - Architecture and requirements
- [Community](./COMMUNITY.md) - Contributing and support
