...
> **Frozen.** Dynamic changelog is generated from specs and observations
> in the Oracle dashboard (`/changelog`). This file preserves historical
> entries from before the dynamic system (pre v0.35.0).
